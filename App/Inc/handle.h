...
extern uint8 Point;                                                                  //图像中点值
extern uint8 imgbuff[CAMERA_SIZE];                                                   //采集到的图像
extern uint8 img[CAMERA_W*CAMERA_H];                                                 //用来存放解压后的图像
...
char Error_Transform(uchar Data, uchar Set);                                         //求取偏差的绝对值
